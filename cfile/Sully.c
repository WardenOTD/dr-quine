...
int main(){
	...
	char* str = "#include <stdio.h>%c#include <fcntl.h>%c#include <unistd.h>%c#include <string.h>%c#include <stdlib.h>%c#include <sys/stat.h>%c%c#define FILENUM (__FILE__[strlen(__FILE__) - 3] == 'y') ? 4 : (__FILE__[strlen(__FILE__) - 3] - 49)%c%cint main(){%c%cint i = %d;%c%cif (--i < 0)%c%c%creturn 0;%c%cint len = snprintf(NULL, 0, %cSully_%cd.c%c, i);%c%cchar filename[len + 1];%c%csnprintf(filename, len + 1, %cSully_%cd.c%c, i);%c%c";
	...
	char* str3 = "char q = 34;%c%cchar t = 9;%c%cchar n = 10;%c%cchar p = 37;%c%cdprintf(fd, str, n, n, n, n, n, n, n, n, n, n, t, FILENUM, n, t, n, t, t, n, t, q, p, q, n, t, n, t, q, p, q, n, t);%c%cdprintf(fd, str2, n, t, q, str, q, n, t, q, str2, q, n, t, q, str3, q, n, t);%c%cdprintf(fd, str3, n, t, n, t, n, t, n, t, n, t, n, t, n, t);%c%c";
	char q = 34;
	char t = 9;
	char n = 10;
	char p = 37;
	dprintf(fd, str, n, n, n, n, n, n, n, n, n, n, t, FILENUM, n, t, n, t, t, n, t, q, p, q, n, t, n, t, q, p, q, n, t);
